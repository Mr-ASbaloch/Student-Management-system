      ...
      <div className="flex flex-col">
        <div className="">
          {/* <div className="flex mt-8 relative justify-center">
            ...
            <Card title="Courses" className="mx-8 bg-red-300 shadow-lg">
              <BiBookAdd size={35} className="absolute right-2 top-2 text-blue-800" />
            ...
            <Card title="Courses" className="mx-8 bg-blue-300">
              <BiBookAdd size={35} className="absolute right-2 top-2 text-green-800" />
